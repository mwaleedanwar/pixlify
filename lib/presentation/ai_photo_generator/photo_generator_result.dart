...
class PhotoGeneratorResult extends StatelessWidget {
  const PhotoGeneratorResult({super.key});
  ThemeService get theme => Get.find<ThemeService>();
  @override
  Widget build(BuildContext context) {
    return GetBuilder<AiPhotoGeneratorController>(
...
class ResultThumbnail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Get.find<AiPhotoGeneratorController>().setFilterByIndex(index);
      },
      child: Column(
